# === train_cbam_resnet_floreview_transfer.py ===
import os
import numpy as np
...
output = layers.Dense(46, activation="softmax", name="classifier")(x)
...
model.save_weights(os.path.join(SAVE_DIR, "cbam_transfer_weights.h5"))
...
plt.title("Confusion Matrix - Test Flat")
plt.xlabel("Predicted")
plt.ylabel("True")
plt.tight_layout()
plt.savefig(os.path.join(SAVE_DIR, "confusion_matrix_46classes.png"))
plt.close()
